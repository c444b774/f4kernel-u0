...
#define LULZACTIVEW_AUTHOR	"TeamHackLG"

// if you changed some codes for optimization, just write your name here.
#define LULZACTIVEW_TUNER "DerTeufel1980 - CastagnaIT - Christopher83 - erik96 - pinkflozd"
 ...
 */
#define DEFAULT_UP_SAMPLE_TIME 1000 // Scale directly to the max, reduce waiting time to 10ms
static unsigned long up_sample_time;

#define DEFAULT_UP_SAMPLE_TIME_SLEEP 40000
...
#define DEFAULT_DOWN_SAMPLE_TIME_SLEEP 35000
